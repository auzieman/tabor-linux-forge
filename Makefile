...
.PHONY: container fetch patch configure kernel package testbundle usbimg nativeimg wikiimg shell clean profile
...
wikiimg:
	$(RUN_IN_CONTAINER) ./scripts/build-a1222-wiki-image.sh
